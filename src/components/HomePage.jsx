...
export const HomePage = () => {
  return (
    <div className="home">
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
        <div className="hp1">
          ...
          <div style={{ width: "40%",display:"flex",justifyContent:"center",flexDirection:'column'}}>
            ...
            <div><h4>Qui ex dolore at repellat, quia neque doloribus omnis<br/>
             adipisci, ipsum eos odio fugit ut eveniet blanditiis <br/>
              praesentium totam non nostrum dignissimos nihil eius<br/> 
              facere et eaque. Qui, animi obcaecati.</h4></div>
      ...
      <div style={{ width: "100%" }} ><Whyuscards/></div>
     ...
     <div style={{ width: "100%", display: "flex", justifyContent: "center" , marginTop:" 40px"}}>
        <div className="hp2">
          ...
          <div style={{ width: "45%",display:"flex",justifyContent:"center",flexDirection:'column'}}>
            <div>
              <h1>
              GIFTS FOR YOUR
                <br />
      ...
      <div style={{ width: "100%" }}> <Tpage/></div>
      <div style={{ width: "100%",marginTop:'40Px' }}><Cpage/></div>
